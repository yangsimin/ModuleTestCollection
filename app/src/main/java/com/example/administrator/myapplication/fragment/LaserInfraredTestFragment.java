...
/**
 * Created by Administrator btnOn 2016/6/25 0025.
 */
public class LaserInfraredTestFragment extends BaseFragment implements View.OnClickListener
{
    ...
    {
        return R.layout.fragment_laserinfrared_test;
    }
    ...
    private void setSpinnerListener(Spinner spinner, final String str)
    {
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    strBanrate = LaserInfraredTestFragment.this.getResources().getStringArray(R.array.banrate)[position];
                }

                if ("strBit".equals(str))
                {
                    strBit = LaserInfraredTestFragment.this.getResources().getStringArray(R.array.nBits)[position];
                }

                if ("strEvent".equals(str))
                {
                    strEvent = LaserInfraredTestFragment.this.getResources().getStringArray(R.array.nEvent)[position];
                }

                if ("strStop".equals(str))
                {
                    strStop = LaserInfraredTestFragment.this.getResources().getStringArray(R.array.nStop)[position];
                }
            }

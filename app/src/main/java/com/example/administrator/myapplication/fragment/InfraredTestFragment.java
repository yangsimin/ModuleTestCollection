...
public class InfraredTestFragment extends BaseFragment implements View.OnClickListener
{
    ...
    private void setSpinnerListener(Spinner spinner, final String str)
    {
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    strBanrate = InfraredTestFragment.this.getResources().getStringArray(R.array.banrate)[position];
                }

                if ("strBit".equals(str))
                {
                    strBit = InfraredTestFragment.this.getResources().getStringArray(R.array.nBits)[position];
                }

                if ("strEvent".equals(str))
                {
                    strEvent = InfraredTestFragment.this.getResources().getStringArray(R.array.nEvent)[position];
                }

                if ("strStop".equals(str))
                {
                    strStop = InfraredTestFragment.this.getResources().getStringArray(R.array.nStop)[position];
                }
            }

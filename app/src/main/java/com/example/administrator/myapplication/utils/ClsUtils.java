...
//                remoteDevice = device; // 如果绑定成功，就直接把这个设备对象传给全局的remoteDevice
    ...
    public static byte[] convertPinToBytes(Class mClass,String mDevice) throws Exception{
        Class[] parameter = new Class[]{mDevice.getClass()};
        Method createBondMethod = mClass.getMethod("convertPinToBytes",parameter);
        byte[] returnValue = (byte[]) createBondMethod.invoke(null,mDevice);

//这里面的null是因为静态方法属于类,不需要实例的支持
        return returnValue;
    }
